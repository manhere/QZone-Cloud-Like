...
(function($) {
	...
	/*********************************************************************************/
		...
		skel.init({
			...
			pollOnce: true,
			breakpoints: {
				'global':	{ range: '*', href: '/default/css/style.css' },
				'desktop':	{ range: '481-', href: '/default/css/style-desktop.css', containers: 1200, grid: { gutters: 25 } },
				'mobile':	{ range: '-480', href: '/default/css/style-mobile.css', containers: '100%', grid: { collapse: true, gutters: 10 }, lockViewport: true }
			}
		});
